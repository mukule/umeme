...
class EducationalLevel(models.Model):
    ...
    def save(self, *args, **kwargs):
        if not self.pk:  # Only on creation, not on updates
            max_index = EducationalLevel.objects.aggregate(Max('index'))['index__max']
...
class Certificate(models.Model):
    name = models.CharField(max_length=255) 
    certifying_body = models.ForeignKey(CertifyingBody, on_delete=models.CASCADE, blank=True, null=True)
    def __str__(self):
        return self.name
...
class Resume(models.Model):
    ...
    county = models.CharField(max_length=255, blank=True, null=True)  # Add county field
    ethnicity = models.ForeignKey(Ethnicity, on_delete=models.SET_NULL, blank=True, null=True)
    ...
    educational_level = models.ForeignKey(EducationalLevel, on_delete=models.SET_NULL, blank=True, null=True)
    field_of_study = models.ForeignKey(FieldOfStudy, on_delete=models.SET_NULL, blank=True, null=True)
...
class BasicEducation(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='basic_education')
    name_of_the_school = models.CharField(max_length=255, blank=True, null=True)
    index_number = models.CharField(max_length=20, blank=True, null=True, unique=True)
    certification_choices = (
        ('KCPE', 'Kenya Certificate of Primary Education (KCPE)'),
        ('KCSE', 'Kenya Certificate of Secondary Education (KCSE)'),
    )
    certification = models.CharField(max_length=10, choices=certification_choices, blank=True, null=True)
    date_started = models.DateField(blank=True, null=True)
    date_ended = models.DateField(blank=True, null=True)
    grade_attained = models.CharField(max_length=10, blank=True, null=True)
    certificate = models.FileField(upload_to='certificates/{user_id}/{basic_education_id}/', blank=True, null=True)
...
class FurtherStudies(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='further_studies')
    institution_name = models.CharField(max_length=255, blank=True, null=True)
    certifications = models.ForeignKey(FurtherStudiesCertification, on_delete=models.SET_NULL, blank=True, null=True)
    course_undertaken = models.CharField(max_length=100, blank=True, null=True)
    date_started = models.DateField(blank=True, null=True)
    date_ended = models.DateField(blank=True, null=True)
    grade = models.CharField(max_length=100, blank=True, null=True)
    certificate = models.FileField(upload_to='certificates/{user_id}/{further_studies_id}/', blank=True, null=True)
...
class Membership(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='memberships', blank=True, null=True)
    ...
    certificate = models.FileField(upload_to='certificates/{user_id}/memberships/', blank=True, null=True)
    
    def __str__(self):
        return self.membership_title
    
class WorkExperience(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='work_experiences', blank=True, null=True)
...
class Certification(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='certifications',blank=True, null=True)
...
class Referee(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='referees')
