...
urlpatterns = [
    ...
    path('reapply/<int:application_id>/', views.reapply_application, name='recall_application'),
    ...
    path('internal_detail/<int:vacancy_id>/', views.internal_detail, name='internal_detail'),
