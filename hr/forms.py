...
class VacancyForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'certifications_required': forms.CheckboxInput(attrs={'class': 'form-check-input'}),  # Add this for certifications
            'college_required': forms.CheckboxInput(attrs={'class': 'form-check-input'}),  # Add this for college required
        }
        labels = {
            'vacancy_type': '',
            'title': '',
            ...
            'published': 'Published',
            'job_discipline': '',
            'certifications_required': 'Certifications Required',  # Label for certifications_required
            'college_required': 'College/University/Further studies',  # Label for college_required
        }
...
class CertificateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['name'].widget.attrs.update({'class': 'form-control', 'placeholder': 'Certificate Name'})
        self.fields['certifying_body'].widget.attrs.update({'class': 'form-control'})
...
class AdminForm(UserCreationForm):
    ...
    class Meta:
        model = CustomUser
        fields = ['access_level', 'email', 'username', 'password1', 'password2']
