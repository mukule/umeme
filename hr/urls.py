...
urlpatterns = [
    ...
    path('Ethnicity/edit/<int:ethnicity_id>/',
         views.edit_ethnicity, name='edit_ethnicity'),
    path('Ethnicity/delete/<int:ethnicity_id>/',
    ...
    path('terms/edit/<int:id>/', views.edit_terms, name='edit_terms'),
    ...
    path('deleteclassf/<int:class_id>/',
         views.delete_class, name='delete_class'),
    path('educational-levels/create/', views.create_educational_level,
