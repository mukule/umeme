...
def check_admin_roles(request):
    ...
    is_master = is_authenticated and request.user.is_superuser
    is_ict = is_authenticated and request.user.function == 10
    is_hradmin = is_authenticated and request.user.function == 1
    is_superuser = is_ict or is_master
    is_superadmin = is_hradmin or is_superuser
    is_post1 = is_authenticated and request.user.function == 2
    is_post2 = is_authenticated and request.user.function == 3
    is_pub1 = is_authenticated and request.user.function == 4
    is_pub2 = is_authenticated and request.user.function == 5
    is_edit1 = is_authenticated and request.user.function == 6
    is_edit2 = is_authenticated and request.user.function == 7
    is_del1 = is_authenticated and request.user.function == 8
    is_del2 = is_authenticated and request.user.function == 9
